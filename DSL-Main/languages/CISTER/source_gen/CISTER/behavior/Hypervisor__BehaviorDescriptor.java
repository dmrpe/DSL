...
public final class Hypervisor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<Void> saveIntermediaryLanguageToFile_id1HXM3RPuFIj = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("saveIntermediaryLanguageToFile").modifiers(SModifiersImpl.create(0, AccessPrivileges.PRIVATE)).concept(CONCEPT).id("1HXM3RPuFIj").registry(REGISTRY).build(SMethodBuilder.createJavaParameter(LinkedList.class, ""));
